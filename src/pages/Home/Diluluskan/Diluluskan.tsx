...
export default function DiluluskanPage() {
  ...
  useEffect(() => {
    const fetchDropdownData = async () => {
      try {
        ...
        const oldestYear = ringkasanData.oldest ?? 2025
        const newestYear = ringkasanData.newest ?? 2026
      ...
      <div className="flex h-full flex-col gap-6">
        <div className="flex flex-col gap-3">
          <div className="flex gap-3 items-center">
            ...
            <MainHeading>Dokumen Diluluskan</MainHeading>
          </div>
          <p className="text-body-sm font-medium text-txt-black-500">
            Terdapat {searchMeta?.totalItems ?? catalogItems.length} dokumen diluluskan.
          </p>
