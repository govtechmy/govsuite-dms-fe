      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col gap-3">
          <div className="flex gap-3 items-center">
            ...
            <MainHeading>Dokumen Perlukan Kelulusan</MainHeading>
          </div>
          <p className="text-body-sm font-medium text-txt-black-500">
            Terdapat {documents.totalRecords} dokumen memerlukan kelulusan.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {currentDocuments.map((doc) => (
              <Excerpts
                ...
                onClick={() => navigate(`/${activeLang}/katalog-dokumen/${doc.document_id}`)}
              />
            ))}
          </div>
        )}
